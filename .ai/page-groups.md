...
| Insights | Blog / market insight index. | Content area for articles and updates. |
| Insight Detail | Single insight/article page. | Public article detail view. |
...
| Market | Market / insights workspace. | Placeholder. |
